...
#    print(tree.right)
#    
#    print(vars(tree.left))
#    print(vars(tree.right))
#    print(vars(tree.right.left))
#    print(vars(tree.right.right))    

##        if Finaltree.data == "+": 
#            result = Finaltree.left + Finaltree.right
#        if Finaltree.data == "-": 
#            result = Finaltree.left - Finaltree.right
#        if Finaltree.data == "*": 
#            result = Finaltree.left * Finaltree.right
...
#            result = Finaltree.left / Finaltree.right 
# def display_tree()    
#    if vars(tree.left)['left'] is None and vars(tree.right)['right'] is None:
#        print(tree.data)
#        a = tree.data
#        x = vars(tree.left)['data']
#        print("left child of "+ a + x)
#        
#        y = vars(tree.right)['data']
#        print("right child of " + a + y)
#    else :
...
#        print(tree.data)
#        return None
#    if vars(tree.left)['left'] is not None:
#        display_tree(vars(tree.left)['left'])
#    if vars(tree.right)['right'] is not None:
#        display_tree(vars(tree.right)['right'])
